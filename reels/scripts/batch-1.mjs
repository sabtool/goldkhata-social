...
const reels = [
  { id: '2026-09-24_reel-pledge-card', cta: TRIAL, scenes: [
    ...
    { type: 'screen', label: '2 · Ornaments', capture: { path: '/loans/new', focus: 'ornaments' }, vo: "Add the ornaments and their weight. The loan amount is worked out at today's gold rate." },
    { type: 'screen', label: '3 · Print', capture: { path: '/loans', focus: 'print' }, vo: 'Save, and the pledge card prints on your own letterhead, ready to sign.' },
  ...
  { id: '2026-09-26_reel-upi-qr', cta: WA, scenes: [
    ...
    { type: 'screen', label: 'Exact amount', capture: { path: '/payments', focus: 'upi-qr' }, vo: 'In Gold Khaataa, the UPI QR already carries the exact amount due. The customer only scans and pays.' },
    { type: 'screen', label: 'Every mode', capture: { path: '/payments', focus: 'modes' }, vo: 'Cash, UPI, both together, bank or cheque. A receipt goes out every time.' },
  ...
  { id: '2026-09-29_reel-already-paid', cta: WA, scenes: [
    ...
    { type: 'screen', label: 'Every receipt', capture: { path: '/loans/:id', focus: 'payments' }, vo: 'Open the loan. Every payment is there, with the date and the exact time.' },
  ...
  { id: '2026-10-01_reel-interest-rules', cta: TRIAL, scenes: [
    ...
    { type: 'screen', label: 'Your rules', capture: { path: '/settings/interest', focus: 'rules' }, vo: 'In Gold Khaataa, you set your own method once. The first month, part months, and yearly compounding.' },
    { type: 'screen', label: 'Every screen follows', capture: { path: '/loans/:id', focus: 'interest' }, vo: 'After that, the loan page, the release bill and every report follow your method.' },
  ...
  { id: '2026-10-03_reel-day-close', cta: WA, scenes: [
    ...
    { type: 'screen', label: 'Cash book', capture: { path: '/cash-close', focus: 'book' }, vo: "Gold Khaataa's cash book records every loan, payment and expense as it happens." },
    { type: 'screen', label: 'Day close', capture: { path: '/cash-close', focus: 'difference' }, vo: 'Count the drawer at closing, and any difference shows up the same evening.' },
  ...
  { id: '2026-10-08_reel-jewellery-bill', cta: WA, scenes: [
    ...
    { type: 'screen', label: 'GST bill', capture: { path: '/jewellery/sales/new', focus: 'items' }, vo: 'Scan the tag, and the item comes onto the bill, with GST worked out.' },
  ...
  { id: '2026-10-10_reel-customer-portal', cta: WA, scenes: [
    ...
    { type: 'screen', label: 'Customer portal', capture: { path: '/portal', focus: 'phone', public: true }, vo: "With Gold Khaataa's customer portal, customers sign in with a code on WhatsApp." },
  ...
  { id: '2026-10-13_reel-part-release', cta: TRIAL, scenes: [
    ...
    { type: 'screen', label: 'Top-up', capture: { path: '/loans/:id', focus: 'topup' }, vo: 'Need more money on the same gold? Add a top-up to the same loan.' },
  ...
  { id: '2026-10-15_reel-gold-rate', cta: WA, scenes: [
    ...
    { type: 'screen', label: 'Live rate', capture: { path: '/dashboard', focus: 'rate' }, vo: "Gold Khaataa shows the live gold rate on every screen, so every loan starts from today's price." },
    { type: 'screen', label: 'Rate broadcast', capture: { path: '/whatsapp/campaigns', focus: 'rate-broadcast' }, vo: 'And a weekly gold rate message goes to your customers, from your own WhatsApp number.' },
